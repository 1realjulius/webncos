    ...
    <div>
      ...
      <div className="py-12">
        <div className="flex flex-col items-center justify-center mx-4">
          <h1 className="text-2xl md:text-6xl py-2">SOLUTIONS ORIENTED</h1>
          <p className="text-center md:text-3xl">
            We’re specialists, not generalists. Our company was built to provide <br className="hidden md:block"/>
