    ...
    <div>
        ...
        <div className="p-2 flex flex-col md:flex-row border border-blue-500">
          <div className="flex flex-row">
            <div className="p-2 text-center">
              ...
              <div>
                <p className="text-xl">The Java Script Framework that makes developing websites super
                functional.</p>
              </div>
            </div>
            <div className="p-2 text-center">
          ...
          <div className=" flex flex-row">
            <div className="p-2 text-center">
              <div>
                <h1 className="text-3xl">Swift</h1>
              </div>
              <div>
                <p className="text-xl">The Java Script Framework that makes developing websites super
                functional.</p>
            ...
            <div className="p-2 text-center">
              <div>
                <h1 className="text-3xl">Kotlin</h1>
              </div>
              <div>
                <p className="text-xl">The Java Script Framework that makes developing websites super
                functional.</p>
      ...
      <div className="my-12">
        <div className="flex flex-col items-center justify-center mx-4">
          <h1 className="text-2xl md:text-6xl">SOLUTIONS ORIENTED</h1>
          <p className="text-center md:text-3xl">
            We’re specialists, not generalists. Our company was built to provide <br />
            deep expertise in digital channels that are extremely complex, and <br />
            changing daily. We offer integrated solutions with unique services <br />
