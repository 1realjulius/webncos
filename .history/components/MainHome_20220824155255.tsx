...
import FeatureImg  from "public/Assets/Julius_Eghan.jpg"
    ...
    <div>
      ...
      <div className="flex flex-row items-center justify-center">
        <div className="flex flex-col gap-2 md:flex-row items-center">
          <div className="flex flex-1 flex-col mx-4 p-2 bg-gray-300">
            <div>
          ...
          <div className="flex flex-2 flex-row mx-4 bg-gray-300">
            <Image src="{FeatureImg}" className="w-10 h-10" width="80" height="80" alt="FeatureImg"/>
          </div>
        </div>
      </div>
