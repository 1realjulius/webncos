        ...
        <>
            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <a
                    href="#"
                    className="text-gray-500 text-base hover:text-gray-900 inline-flex items-center px-1 pt-1 "
                  >
                    Features
                  </a>
                  <a
                    href="#"
                    className=" text-gray-500 hover:text-gray-900 inline-flex items-center px-1 pt-1  text-base"
                  >
                    Testimonials
                  </a>
                  <a
          ...
          <Disclosure.Panel className="sm:hidden border-2 rounded-lg px-4 mx-2">
            <div className="flex flex-col pt-4 space-y-1 items-center">
              <a
               className="hover:bg-gray-100 w-full text-center py-2 rounded-md text-base"
               href="#"
               >Features</a>
              <a
               className="hover:bg-gray-100 w-full text-center py-2 rounded-md text-base"
