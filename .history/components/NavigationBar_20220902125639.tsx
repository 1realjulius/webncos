    ...
    <Disclosure as="nav" className="bg-blue-200">
      {({ open }) => (
        <>
          ...
          <Disclosure.Panel className="sm:hidden border-2 border-blue-500 bg-blue-400 rounded-lg px-2 mx-2">
            <div className="flex flex-col pt-2 space-y-1 items-center">
              <a
                className="hover:bg-blue-100 w-full text-center py-2 rounded-md text-lg"
                href="#"
              >
                Features
              </a>
