  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center py-4">
        <div className="flex flex-col md:grid md:grid-cols-3 gap-2 items-center max-w-6xl mx-auto ">
          <div className="flex flex-col border border-gray-300 p-2 rounded-md m-4">
