            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                <div className="flex-shrink-0 flex items-center">
                  {/* the logo */}
                  <Link href="#">
                  <h1 className="text-lg leading-none flex flex-row items-center cursor-pointer">
                    <span>
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <a
                    href="#"
                    className="text-gray-500 text-lg hover:text-gray-900 inline-flex items-center px-1 pt-1 "
                  >
                    Features
                  </a>
                  <a
                    href="#"
                    className=" text-gray-500 hover:text-gray-900 inline-flex items-center px-1 pt-1  text-lg"
                  >
                    Testimonials
                  </a>
                  <a
