      ...
      {({ open }) => (
        <>
            ...
            <div className="flex justify-between h-16">
              <div className="flex">
                <div className="flex-shrink-0 flex items-center">
                  {/* the logo */}
                  <Link href="#">
                  <h1 className="text-base leading-none flex flex-row items-center cursor-pointer">
                    <span>
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <a
                    href="#"
                    className="text-gray-500 hover:text-gray-900 inline-flex items-center px-1 pt-1 text-sm "
                  >
                    Features
                  </a>
                  <a
              ...
              <div className="hidden sm:ml-6 sm:flex sm:items-center">
                <Link href='#'>
                <div className="px-3 py-1 bg-blue-200 rounded-md cursor-pointer">
                  <h2 className="text-blue-800 text-sm">Contact Us</h2>
                </div>
                </Link>
              </div>
          ...
          <Disclosure.Panel className="sm:hidden border-2 rounded-lg px-4 mx-2">
            <div className="flex flex-col pt-4 space-y-1 items-center">
              <a
               className="hover:bg-gray-100 w-full text-center py-2 rounded-md"
               href="#"
               >Features</a>
              <a
               className="hover:bg-gray-100 w-full text-center py-2 rounded-md"
            ...
            <div className="flex py-2 items-center justify-center">
              <Link href="#">
                <div className="px-3 py-1 bg-blue-200 hover:bg-blue-300 rounded-md cursor-pointer">
                  <h2 className="text-blue-800 text-sm">Contact Us</h2>
                </div>
              </Link>
            </div>
