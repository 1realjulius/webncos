  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex flex-col max-w-7xl">
        {/* header */}
        <div className="flex md:my-2 min-h-screen items-center justify-center flex-col">
          <div className=" flex flex-col items-center justify-center">
            <div className="pt-4 pb-2">
              <h1 className="text-6xl md:text-9xl text-center px-2 font-ApercuBold">
        ...
        {/* We develop brands */}
        <div className=" hidden flex-col bg-white p-4 px-4 md:px-24 items-center justify-center">
          <div className="py-2">
          ...
          <div className="p-2 flex flex-col md:flex-row border-2 border-blue-400 bg-blue-200 rounded-lg">
              ...
              <div className="p-2 text-center">
                ...
                <div>
                  <p className="text- base md:text-xl">
                    The React Framework that makes developing websites super
                    functional.
                  </p>
                </div>
              </div>
              <div className="p-2 text-center">
                <div className="flex flex-col items-center">
                  <div className="flex flex-row items-center">
                    ...
                    <span className="ml-2.5 font-cadizMedium">
                      React Native
                    </span>
                  </div>
                </div>
            ...
            <div className=" flex flex-row">
              ...
              <div className="p-2 text-center">
                ...
                <div>
                  <p className="text- base md:text-xl">
                    Webflow is an asome no-code solution we have for our
                    clients.
                  </p>
                </div>
              </div>
        ...
        <div className="hidden py-12 ">
          <div className="flex flex-col items-center justify-center mx-4">
            ...
            <p className="text-center text-2xl md:text-3xl md:px-14">
              We’re specialists, not generalists. Our company was built to
              provide deep expertise in digital channels that are extremely
              complex, and changing daily. We offer integrated solutions with
              unique services and deliverables tailored to unlock full-funnel
              growth.
            </p>
          </div>
        </div>
