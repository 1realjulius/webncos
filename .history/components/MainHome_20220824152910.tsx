      ...
      <div className="flex flex-col mx-8">
        <div className="border border-gray-300 rounded-xl">
          <div className="grid grid-cols-3 bg-gray-100 rounded-xl">
            <div className="border-b border-r border-gray-300 bg-white">try1</div>
            <div className="border-b border-r border-gray-300 bg-white">try1</div>
            <div className="border-b-2 border-gray-300 bg-white">try1</div>
            <div className="border-r-2 border-gray-300 bg-white">try1</div>
            <div className="border-r-2 border-gray-300 bg-white">try1</div>
            <div className=" bg-white">try1</div>
          </div>
        </div>
      </div>
