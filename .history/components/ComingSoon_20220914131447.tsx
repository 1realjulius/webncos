        ...
        <div className="absolute bottom-6">
          <Link href="https://www.iamjulius.com/">
            <div className="flex flex-row items-center space-x-2 shadow-md px-3 py-1 rounded-full cursor-pointer group ">
              <span className="text-gray-400 group-hover:text-black hover:transition duration-400">
                {" "}
                Made with
              </span>
              <span>
              ...
              <h1 className="flex flex-row items-center text-blue-300 group-hover:text-blue-600 hover:transition duration-400">
