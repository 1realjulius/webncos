  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between md:p-8 p-6">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <Image src='/wenncos.svg' alt='wenco' className='w-4 h-4' width='18' height='18'/>
      </div>
            ...
            <span>
              <svg className="h-6 w-6 " viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  fill="#E879F9"
                  className="fill-blue-500  dark:fill-slate-300"
                ></path>
                <path
                  ...
                  fill="#F0ABFC"
                  className="fill-blue-600 dark:fill-slate-400"
                ></path>
              </svg>
            </span>
