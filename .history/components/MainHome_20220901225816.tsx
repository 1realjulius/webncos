      ...
      <div>
        <div className=" flex flex-col items-center justify-center mt-20 mb-10">
          <div className="pt-4 pb-2">
            <h1 className="text-6xl md:text-9xl text-center font-parcel">
              ESTABLISH YOUR BRAND AWARENESS,
            </h1>
          </div>
          <div className="pb-4">
            <h2 className="text-xl md:text-3xl font-parcel">
              GET YOUR WEBSITE TO SPEAK ABOUT YOUR BRAND.
            </h2>
          </div>
          <div className="flex flex-col md:flex-row items-center">
            <div className="px-3 py-1 my-2">
              <Link href="#">
                <h3 className="text-gray-500 hover:text-gray-900 cursor-pointer text-base">
            ...
            <Link href="#">
              <div className="px-3 py-1 rounded-md bg-blue-200 active:bg-blue-300 my-2 cursor-pointer">
                <h3 className="text-blue-800 text-base">Join Our Agency</h3>
              </div>
            </Link>
          </div>
        </div>
