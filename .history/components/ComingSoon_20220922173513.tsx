        ...
        <div className="absolute bottom-6">
          <Link href="https://www.iamjulius.com/">
            <div className="flex flex-row items-center space-x-2 shadow-md px-3 py-1 rounded-full cursor-pointer group bg-white">
              <span className="text-black group-hover:text-gray-400 hover:transition duration-500">
                {" "}
                Made with
              </span>
              <span>
              ...
              <h1 className="flex flex-row items-center text-blue-600 group-hover:text-blue-300 hover:transition duration-500">
