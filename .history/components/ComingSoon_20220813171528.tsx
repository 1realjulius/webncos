      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <span>
          <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none">
            ...
            <path d="M13 12C13 11.4477 13.4477 11 14 11H17C17.5523 11 18 11.4477 18 12V17C18 17.5523 17.5523 18 17 18H14C13.4477 18 13 17.5523 13 17V12Z" fill="#F0ABFC" className="fill-blue-600 dark:fill-slate-400"></path>
          </svg>
        </span>
      </div>
